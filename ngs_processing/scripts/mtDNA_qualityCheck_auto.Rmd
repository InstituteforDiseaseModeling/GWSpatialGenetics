...
outlier_samples <- percent_covered[percent_covered$covered_bases < 50, "sample"]
kable(percent_covered[percent_covered$covered_bases < 50, ])

# write out this table
outf <- file.path(plot_output_dir, "mtDNA_poor_breadth_samples.tsv")
write.table(percent_covered[percent_covered$covered_bases < 50, ], outf, sep='\t', quote = F, row.names = F, col.names = T)
```
