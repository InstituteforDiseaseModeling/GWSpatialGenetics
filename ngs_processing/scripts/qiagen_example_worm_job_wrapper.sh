...
#SBATCH -J GWEP_worm_analysis_batch_Apr042025
#SBATCH -o worm_batch_Apr042025.out
#SBATCH -e worm_batch_Apr042025.err
...
datadir="/home/rarthu3/projects/worm/batch_Apr042025"
workdir=$(pwd)
...
#snakemake -s /home/rarthu3/git/worm/scripts/generate_manifest.smk --config fastq_dir='/home/rarthu3/projects/worm/batch_Apr042025/' output_file='/home/rarthu3/projects/worm/batch_Apr042025/metadata.tsv' sample_key='sample-key.csv'
